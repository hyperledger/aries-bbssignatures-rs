...
| ----- | ---------- | ----------- | ----------- |
| Maintainer | The GitHub Maintain role | Maintain   | `aries-bbs-maintainers`     |
...
| ----------------- | --------------- | ---------- | ---- | ---------- | ----- | ------------------- |
| Michael Lodder    | mikelodder7     | Maintainer |      |            |       |                     |
| Stephen Curran    | swcurran        | Maintainer |      |            |       | BC Gov              |
| Wade Barnes       | WadeBarnes      | Maintainer |      |            |       | BC Gov              |
| Andrew Whitehead  | andrewwhitehead | Maintainer |      |            |       | BC Gov              |
| Timo Glastra      | TimoGlastra     | Maintainer |      |            |       | Animo Solutions     |
